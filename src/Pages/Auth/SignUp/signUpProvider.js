...
import { FormSchema } from "../../../Shared/Formik/formik";
...
const SignUpProvider = () => {
  ...
  const handleSignUp = async (obj, name, email) => {
            ...
            <Container className="containerAuth">
              <Formik
                ...
                onSubmit={(values) => {
                  ...
                  handleSignUp(obj, values.name);

                  // naviagte("/profile-setup", { state: { values } })
                }}
              >
                {({ values, errors, touched, handleChange, handleSubmit }) => (
                  <>
                    <Form>
                      ...
                      <Card.Text className=" marginNone mt-3 emailAuth mb-1">
                        Email
                      </Card.Text>
                      <Field
                        name="email"
